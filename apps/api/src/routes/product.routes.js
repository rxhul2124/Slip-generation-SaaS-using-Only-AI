...
productRouter.post("/", requireAtLeast("manager"), audit("product.create", "product"), validate(productSchema), products.create);
productRouter.post("/import", requireAtLeast("manager"), upload.single("file"), audit("product.import", "product"), importProducts);
